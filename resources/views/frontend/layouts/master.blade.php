                ...
                <div class="row">
                    <div class="col-xl-6 col-md-8">
                        <ul class="fp__topbar_info d-flex flex-wrap">
                            ...
                            <li><a href="mailto:img000418@gmail.com"><i class="fas fa-envelope"></i> img000418@gmail.com</a></li>
                            @endif
                            @if (config('settings.site_phone') != NULL)
                            <li><a href="callto:0168042668"><i class="fas fa-phone-alt"></i>0168042668</a></li>
                            @endif
                        </ul>
                    </div>
                    @php
